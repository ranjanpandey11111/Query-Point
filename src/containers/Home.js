...
import { Write, MemoList,leftNav } from 'components';
import {
    memoPostRequest,
    memoListRequest,
    memoEditRequest,
...
class Home extends React.Component {
    ...
    render() {
		...
		const leftNav = (<leftNav onPost={this.handlePost}/>);
        ...
        return (
            <div className="wrapper">
                {this.props.isLoggedIn ? <leftNav onPost={this.handlePost}/> : undefined }
